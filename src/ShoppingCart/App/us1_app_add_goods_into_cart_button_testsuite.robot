...
Open Goods Page
    ...
    Input Text    id=com.taobao.taobao:id/search_bar    诺基亚    #任意输入商品关键词
    Wait And Click Element    id=com.taobao.taobao:id/search_button    #输入框右边的搜索按钮
    Wait And Click Element    id=com.taobao.taobao:id/rfq_quote_array_item_img    #搜索到的商品以列表方式显示出来,点击第一个
